...
public class SkillController {
    ...
    @ApiMessage("delete skills success")
    public ResponseEntity<Void> deleteSkills(@PathVariable("id") long id) throws IdInvalidException {
        boolean existById = this.skillService.existById(id);
        if (existById != true) {
